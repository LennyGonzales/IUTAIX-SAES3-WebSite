...
<html>
  ...
  <form class="box" action="" method="post">
    <h1 class="box-logo box-title"> </h1>
      ...
      <input type="text" class="box-input" name="user_password" placeholder="Mots de passe" required />
      <input type="submit" name="submit" value="S'inscrire" class="box-button" onclick="$res" />
      <p class="box-register">Déjà inscrit? <a href="connectionPage.php">Connectez-vous ici</a></p>
  </form>
</html>
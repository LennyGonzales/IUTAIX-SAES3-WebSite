...
echo "
    ...
    <div class='container' id='container'>
        ...
        <section class='form-container sign-up-container'>
            <form class='default-form' id='formulaire' action='/account/signUpRequest' method='POST' onSubmit='return false;'>
                    <h1>Créer un compte</h1>
                    <input type='text' class='box-input' name='email' placeholder='Email universitaire' required />  
                    <div class='password'>
                        <input type='password' id='signup_password_text' class='box-input' name='user_password' placeholder='Mot de passe' required />
        ...
        <section class='form-container sign-in-container'>
            <form class='default-form' action='/account/connect' method='POST'>
                <h1>Connexion</h1>
                <input type='text' class='box-input' name='email' placeholder='Email universitaire'/>
                <div class='password'>
